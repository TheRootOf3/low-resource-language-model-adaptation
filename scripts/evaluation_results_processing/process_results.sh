...
# CPT
# GENERATIONS_PATH=$BASE_PATH/generations/zero-shot/wura
# OUTPUT_PATH=$BASE_PATH/results/zero-shot/wura

# IT
GENERATIONS_PATH=$BASE_PATH/generations/zero-shot/aya
OUTPUT_PATH=$BASE_PATH/results/zero-shot/aya
